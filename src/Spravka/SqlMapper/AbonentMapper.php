...
class AbonentMapper {
    ...
    private function saveRemovedAbonent(array $abonent) {
        unset($abonent["id"]);
        $sql = "INSERT INTO phonebook_removed (city, phone, name, owner, address, info, info, is_company, data, user_id) 
                VALUES (:city, :phone, :name, :owner, :address, :info, :info, :is_company, :data, :user_id);";
